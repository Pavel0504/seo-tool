...
-- URL checks table: stores individual URL analysis results
...
-- SEO issues table: stores identified issues
...
-- Exclusion rules table: URLs to exclude from sitemap
